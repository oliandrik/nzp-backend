...
let UpdatesService = class UpdatesService {
    ...
    async create(body, mark) {
        return await this.updateRepository.insert(Object.assign(Object.assign({}, body), { mark: mark.toUpperCase(), created_at: new Date(), updated_at: new Date() }));
    }
};
UpdatesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_2.InjectRepository)(updates_entity_1.Update)),
