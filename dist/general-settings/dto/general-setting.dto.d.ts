import { EEmailConfirmation, EResetPassword, ESignupPage, ETermsCheckbox, ETicketSystem } from '../interfaces/general-settings.interfaces';
export declare class GeneralSettingDto {
    id: bigint;
    logo: string;
    favicon: string;
    panel_name: string;
